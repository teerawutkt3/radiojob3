...
<div class="messages-index">
    <div class="panel panel-default">
              <div class="panel-body panel-body1 "><h3 class="text-center" ><?= Html::encode($this->title) ?></h3></div>
    </div>
		   ...
		   <?php $form = ActiveForm::begin(); ?>
				...
				<div class="col-md-6"><br>
					...
					<?=Html::a('จดหมายที่ส่งแล้ว','/letter/send-total',['class'=>'btn btn-success'])?></div>
					<div class="col-md-5">

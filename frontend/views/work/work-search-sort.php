...
<div class="panel panel-default">
  ...
  <div class="panel-body panel-body3 ">
  		<h3 class="text-center"><b><img class="center" alt="" src="/img/logo.png" style="width:4%;  "> งานประกาศ โดยเรียงลำดับจาก<u >รายได้ที่มากที่สุด</u></b></h3>
  </div>		<!-- end panel body -->
</div>	<!-- end panel -->
...
<div class="row">
			...
			<div class="pull-right">
					<h4>มุมมอง : 
                <a href="/work/work-search-sort" title="มุมมองแบบกว้าง "class="btn btn-default"><span class="	glyphicon glyphicon-list"></span></a>
                    	<a href="/work/work-search-sort-list" title="มุมมองแบบ list"  class="btn btn-default"><span class="	glyphicon glyphicon-align-justify"></span></a>
                    </h4> 
               </div>	
			</div>
</div>
			...
			<div class="panel panel-defualt">
                  ...
                  <div class="panel-body panel-body2">
                			<div class="col-md-4">
                                            ...
                                            <span class="badge glyphicon glyphicon-hand-right"> เพ่ิ่มเติม</span> </a> 
                                             <?php endforeach;?>
                                             </div>

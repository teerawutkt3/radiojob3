...
<div class="panel panel-default">
  ...
  <div class="panel-body panel-body3 ">
  		<h3 class="text-center"><b><img class="center" alt="" src="/img/logo.png" style="width:4%;  "> ค้นหาตามเวลาประกาศ</b></h3>
  </div>		<!-- end panel body -->
</div>	<!-- end panel -->
...
<div class="row">
			...
			<div class="col-md-3">
				<div class="pull-right">
					<h4>มุมมอง : 
                  <a href="/work/work-search-normal" title="มุมมองแบบกว้าง "class="btn btn-default"><span class="	glyphicon glyphicon-list"></span></a>
                    	<a href="/work/work-search-normal-list" title="มุมมองแบบ list"  class="btn btn-default"><span class="	glyphicon glyphicon-align-justify"></span></a>
                    </h4> 
                    </div>	
			</div>
</div>

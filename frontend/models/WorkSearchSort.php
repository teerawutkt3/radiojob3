 ...
 */
class WorkSearchSort extends Work
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['name_office', 'description','money1', 'belong', 'education', 'benefits','work_created_at', 'work_status','geo_id','province_id','amphur_id','district_id' ], 'safe'],
        ];
    }
    ...
    {
        $query = Work::find()->where(['work_status'=>Work::STATUS_ACTIVE])->orderBy(['money1'=>SORT_DESC]);
        ...
        ->andFilterWhere(['like', 'belong', $this->belong])
            ...
            //->andFilterWhere(['like','workAddress.province_name',$this->address_search])

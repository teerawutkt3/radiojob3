   ...
   //    die();
    ...
    public function actionRegister()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                if ($auth_assignment->load(\Yii::$app->request->post()) ){
                  
                    $auth_assignment->user_id = $model->id;
                    if ($auth_assignment->item_name == '0'){
                        $auth_assignment->item_name = 'public_relations';
                    }else $auth_assignment->item_name = 'radiologist';
                  
                //    var_dump($auth_assignment->item_name); die();
    ...
    public function actionIndex()
    {
        if(!\Yii::$app->user->isGuest){
                ...
                }else if (\Yii::$app->user->can('public_relations')){
